                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1.5 text-xs font-bold rounded-lg transition-all cursor-pointer ${paymentFilter === tab.id
                    ...
                    <div className="flex gap-1 mx-1 sm:mx-2 overflow-x-auto custom-scrollbar pb-1 sm:pb-0 items-center">
                      {Array.from({ length: totalReturnsPages }, (_, i) => i + 1).map((page) => (
                        <button
                          ...
                          className={`min-w-8 h-8 px-2 flex items-center justify-center rounded-lg text-sm font-medium border transition-colors shrink-0 ${page === currentReturnsPage
